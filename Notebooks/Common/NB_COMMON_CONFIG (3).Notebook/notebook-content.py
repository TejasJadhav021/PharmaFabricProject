...
data = [
    ...
    Row(USER_EMAIL="north@pharma.com", REGION="North"),

    Row(USER_EMAIL="south@pharma.com", REGION="South"),

    Row(USER_EMAIL="east@pharma.com", REGION="East"),

    Row(USER_EMAIL="west@pharma.com", REGION="West")

]

df = spark.createDataFrame(data)

df.write.mode("overwrite").format("delta").saveAsTable("USER_REGION_SECURITY")
